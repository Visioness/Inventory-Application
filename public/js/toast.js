function showToast(message, type = 'success') {
  ...
  // Base classes
  let classes =
    'pointer-events-auto border-1 border-neutral-500 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow transition-all duration-300 opacity-0 translate-y-[-10px]';
